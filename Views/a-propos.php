...
<body>
    ...
    <main>
        ...
        <section class="about-us-section width-section">
            ...
            <p>Fondée en 2011, Fit and Forme est une association loi 1901 affiliée à la Fédération Sport pour Tous. <br>
                <br>
        ...
        <section class="team-section width-section">
            ...
            <article class="personal-card">
                <div class="personal-photo">
                    <img class="" src="img/img à propos/marie-ange.png"
                        alt="Une photo de la présidente de l'association">
                </div>
                <div class="personal-info unbounded">
                    <p>Présidente</p>
                    <h3>Marie-Ange Boursin</h3>
                </div>
            </article>
            <article class="personal-card">
                <div class="personal-photo">
                    <img class="" src="img/img à propos/aline.png" alt="Une photo de la trésorière de l'association">
                </div>
                <div class="personal-info unbounded">
                    <p>Trésorière</p>
                    <h3>Aline Sevillano</h3>
                </div>
            </article>
            <article class="personal-card">
                <div class="personal-photo"><img class="" src="img/img à propos/valérie.png"
                        alt="Une photo de la secrétaire de l'association"></div>
                <div class="personal-info unbounded">
                    <p>Secrétaire</p>
                    <h3>Valérie Imbault</h3>
                </div>
            </article>
            <article class="personal-card">
                <div class="personal-photo"><img class="" src="img/img à propos/elodie.png"
                ...
                <div class="personal-info unbounded">
                    <p>Educatrice sportive, titulaire du BPJEPS Activités gymniques de la forme et de la force (mention
                        ...
                        (2023)</p>
                    <h3>Elodie Sergent<a target="_blank" href="https://www.facebook.com/elodie.fit.50"> <img
                                src="img/facebook-black-icon.png" alt="facebook black icon"></a></h3>
                </div>
            </article>
        </section>
    </main>
            ...
            <div class="footer-section links footer-center">
                <div class="footer-section social-media">
                    <a target="_blank" href="https://www.facebook.com/fitandforme45/" class="social-networking"><img
                            src="img/facebook.png" alt="Facebook white icon"></a>
                    <a target="_blank" href="https://www.instagram.com/fit_andforme/" class="social-networking"><img
                            src="img/instagram.png" alt="Instagram white icon"></a>
                </div>
                <ul>
