    ...
    <div>
        <div class="footer-section links footer-center">
            ...
            <ul class="pages-links">
                <li><a class="a-nav-footer" href="/courses">Cours</a></li>
                <li><a class="a-nav-footer" href="/events">Evenements</a></li>
                <li><a class="a-nav-footer" href="/planning">Planning</a></li>
                <li><a class="a-nav-footer" href="/aboutus">À propos</a></li>
                <li><a class="a-nav-footer" href="mentions.html">Mentions légales</a></li>
            </ul>
        </div>
    </div>
